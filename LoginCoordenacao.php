...
if(isset($_POST['email']) || isset($_POST['senha'])) {
    ...
    if(strlen($_POST['email']) == 0) {
        ...
        $sql_code =$obj_baco->getConexao()->prepare("SELECT * FROM professor WHERE email = '$emailDigitado' AND senha = '$senhaDigitado'");
        ...
        if($permitir == "s"){
            header("Location: http://localhost:8080/view/TelaPrincipal.php");
        }else{
